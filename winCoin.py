...
#adding signature to transactions
...
import requests
# from uuid import uuid4		# used for creating unique id
try:
	from urllib.parse import urlparse
except ImportError:
	from urlparse import urlparse  		# for extracting url from address
...
class Blockchain():
	...
	def update_chain(self):
		...
		for node in network:
			response= requests.get('http://%s/get_chain' % node)		# its a json file
...
def mine_block():
	...
	blockchain.add_transaction(sender= 'reward', receiver= 'Satoshi', amount= 1000)
